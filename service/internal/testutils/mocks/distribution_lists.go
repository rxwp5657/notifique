...
//
//	mockgen -source=./internal/controllers/distribution_lists.go -destination=./internal/testutils/mocks/distribution_lists.go -package=mocks
//
...
func (m *MockDistributionRegistry) GetDistributionLists(ctx context.Context, filter dto0.PageFilter) (dto0.Page[dto.DistributionListSummary], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDistributionLists", ctx, filter)
	ret0, _ := ret[0].(dto0.Page[dto.DistributionListSummary])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDistributionRegistry) GetRecipients(ctx context.Context, distlistName string, filter dto0.PageFilter) (dto0.Page[string], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRecipients", ctx, distlistName, filter)
	ret0, _ := ret[0].(dto0.Page[string])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
