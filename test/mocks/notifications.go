...
//
//	mockgen -source=./controllers/notifications.go -destination ./test/mocks/notifications.go
//
...
func (mr *MockNotificationStorageMockRecorder) SaveNotification(ctx, createdBy, notification any) *gomock.Call {
...
func (mr *MockNotificationStorageMockRecorder) UpdateNotificationStatus(ctx, statusLog any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
