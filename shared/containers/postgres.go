...
import (
	...
	p "github.com/notifique/service/pkg/deployments"
)
...
func (pc *Postgres) GetPostgresUrl() (string, error) {
	return pc.URI, nil
}

func NewPostgresContainer(ctx context.Context) (*Postgres, func(), error) {
	...
	return &Postgres{URI: uri}, close, nil
}
